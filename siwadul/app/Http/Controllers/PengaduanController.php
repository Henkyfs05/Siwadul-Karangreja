...
class PengaduanController extends Controller
{
  ...
  public function index()
  {
    return view('auth.pengaduan.index', [
      'pengaduan' => Pengaduan::whereNotIn('status',['Selesai', 'Ditolak'])->orderBy('created_at', 'asc')->get(),
      'pengaduanselesai' => Pengaduan::whereIn('status',['Selesai', 'Ditolak'])->orderBy('updated_at', 'desc')->get(),
    ]);
  }
  ...
  public function index2()
  {
    ...
    return view('auth.pengaduan.index', [
      'pengaduan' => Pengaduan::where('user_id', auth()->user()->id)->orderBy('created_at', 'asc')->get()
    ]);
  }
  ...
  public function store(Request $request)
  {
    ...
    if ($request->file('gambar')) {
      $pathimg = $request->file('gambar')->store('public/images');
      $validatedData['gambar'] = str_replace("public/", "", $pathimg);
    }
